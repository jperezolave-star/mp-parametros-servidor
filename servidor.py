...
def get_drive_service():
    ...
    # Refresh manual via HTTP, evita problemas de version de google-auth
...
def generar():
    ...
    try:
        ...
        with open(word_out, "rb") as f:
            word_b64 = base64.b64encode(f.read()).decode()
        ...
        return jsonify({"ok":True,
                        ...
                        "excel_b64":      excel_b64,
                        "word_b64":       word_b64,
                        "excel_filename": os.path.basename(excel_out),
                        "word_filename":  os.path.basename(word_out)})
